...
set(MSG_I_FLAGS "-Iturtlebot_msgs:/home/udacity-workspace-backup/catkin_ws/src/turtlebot_msgs/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg;-Isensor_msgs:/opt/ros/kinetic/share/sensor_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/kinetic/share/geometry_msgs/cmake/../msg")
...
add_custom_target(_turtlebot_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "turtlebot_msgs" "/home/udacity-workspace-backup/catkin_ws/src/turtlebot_msgs/srv/SetFollowState.srv" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/turtlebot_msgs)
  install(CODE "execute_process(COMMAND \"/root/miniconda3/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/turtlebot_msgs\")")
  # install generated code
  install(
